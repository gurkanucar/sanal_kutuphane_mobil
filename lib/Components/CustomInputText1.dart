...
class CustomInputText1 extends StatefulWidget {
  ...
  CustomInputText1({@required this.fontSize,@required this.hint,@required this.isNumeric, @required this.onChanged,@required this.size,@required this.showError,@required this.errorMessage});
